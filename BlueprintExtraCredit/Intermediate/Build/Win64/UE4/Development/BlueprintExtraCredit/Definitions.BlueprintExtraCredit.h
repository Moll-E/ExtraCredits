#undef BLUEPRINTEXTRACREDIT_API
...
#define ORIGINAL_FILE_NAME "BlueprintExtraCredit.exe"
#define UE_IS_ENGINE_MODULE 0
#define UE_PROJECT_NAME BlueprintExtraCredit
...
#define CORE_API 
#define BLUEPRINTEXTRACREDIT_API 
